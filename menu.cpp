...
void menu::on_pushButton_equipement_3_clicked()
{
    QMessageBox::information(nullptr, QObject::tr("Gestion Programme"),
                                    QObject::tr("Welcome Malek."), QMessageBox::Ok);
     malek.show();
}

void menu::on_pushButton_equipement_5_clicked()
{
    QMessageBox::information(nullptr, QObject::tr("Gestion Employe"),
                                    QObject::tr("Welcome wissem."), QMessageBox::Ok);
    wissem.show();
}
