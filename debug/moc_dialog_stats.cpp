...
struct qt_meta_stringdata_Dialog_stats_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Dialog_stats_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Dialog_stats_t qt_meta_stringdata_Dialog_stats = {
    {
QT_MOC_LITERAL(0, 0, 12) // "Dialog_stats"
...
const QMetaObject Dialog_stats::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_stats.data,
      qt_meta_data_Dialog_stats,  qt_static_metacall, nullptr, nullptr}
};
...
void *Dialog_stats::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_stats.stringdata0))
