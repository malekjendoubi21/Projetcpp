        ...
        , ui(new Ui::gestion_equipement)
{
    ...
    ui->lineEdit_etat->setMaxLength(8);
    ui->lineEdit_type->setMaxLength(8);
...
*/
   ...
   void gestion_equipement::on_pushButtonajfficher_clicked()
   {
       ui->tableView_equipement->setModel(E.afficherequipement());
   }

   void gestion_equipement::on_pushButtonajouter_clicked()
   {
           ...
           if(test)
                 {
                       ...
                       QMessageBox::information(nullptr, QObject::tr("ajout avec succes"),
                                ...
                                QString nomFile ="Historique";
                                            QFile file("C:\\Users\\imedk\\OneDrive\\Documents\\integ\\"+nomFile+".txt");
   ...
   void gestion_equipement::on_pushButtonsupprimer_clicked()
   {
       equipement E1;
   ...
   void gestion_equipement::on_pushButtonmodifier_clicked()
   {
   ...
   void gestion_equipement::on_rechercher_EQUIPEMENT_textChanged()
   {
   ...
   void gestion_equipement::on_trier_equipement_activated()
   {
   ...
   void gestion_equipement::on_pushButtonPDF_clicked()
   {
       QPdfWriter pdf("C:\\Users\\imedk\\OneDrive\\Documents\\integ\\PDF_Equipment.pdf");
   ...
   void gestion_equipement::on_pushButtonStatestique_clicked()
   {
